...
from algorithms.comperession import run_compression_example
...
class CompressionPage(ctk.CTkFrame):
    ...
    def run_example(self, i):
        result = run_compression_example(i)
        self.info_label.configure(text=str(result))
    ...
    def animate_step(self):
        ...
        self.after(delay, self.animate_step)